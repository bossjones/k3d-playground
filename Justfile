...
demo-prebuilt: nuke-cluster k3d-demo deploy-ingress-nginx deploy-external-secrets argocd-install certs-only argocd-secret install-secret-0 templates argocd-password argocd-bridge
